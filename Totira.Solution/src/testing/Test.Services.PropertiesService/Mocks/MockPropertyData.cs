...
namespace Test.Services.PropertiesService.Mocks
{
    ...
    { 
        internal static PropertyController GetPropertyControllerSut(
              ...
              out Mock<IQueryHandler<QueryPropertyApplicationDetail,GetPropertyApplicationDetailDto>> getPropertyApplicationDetailHandler
            )
        {
            ...
            getPropertyApplicationDetailHandler = new Mock<IQueryHandler<QueryPropertyApplicationDetail, GetPropertyApplicationDetailDto>>();
            ...
            return new PropertyController(
                ...
                getPropertyApplicationDetailHandler: getPropertyApplicationDetailHandler.Object) ;
        }
