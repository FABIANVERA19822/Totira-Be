...
namespace Test.Services.PropertiesService.Controllers
{
    public class PropertyControllerTest
    {
        ...
        public async Task GetProperty_Ok()
        {
            ...
            var controller = MockPropertyData.GetPropertyControllerSut(out Mock<IQueryHandler<QueryPropertyByMlnum, GetPropertyDetailsDto>> getypropertydataByIdHandlerMock
