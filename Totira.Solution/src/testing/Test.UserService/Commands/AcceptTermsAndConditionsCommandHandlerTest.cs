...
{
    public class AcceptTermsAndConditionsCommandHandlerTest : BaseCommandHandlerTest<AcceptTermsAndConditionsCommand, AcceptTermsAndConditionsCommandHandler>
    {
        ...
        protected override AcceptTermsAndConditionsCommandHandler CommandHandler =>
            new AcceptTermsAndConditionsCommandHandler(
                _tenantTermsAndConditionsAcceptanceInfoMockRepository.Object,
                _loggerMock.Object,
                _contextFactoryMock.Object,
                _messageServiceMock.Object);

        public AcceptTermsAndConditionsCommandHandlerTest()
            : base(new AcceptTermsAndConditionsCommand()
            {
