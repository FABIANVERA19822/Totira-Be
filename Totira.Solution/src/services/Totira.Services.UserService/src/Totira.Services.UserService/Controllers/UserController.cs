...
namespace Totira.Services.UserService.Controllers
{
    public class UserController : DefaultBaseController
    {
        ...
        private readonly IQueryHandler<QueryTenantPropertyApplication, GetPropertyAppliedDto> _getTenantPropertyApplicationHandler;
        #region Landlord
        ...
        private readonly IQueryHandler<QueryLandlordApplicationsListPageByLandlordId, GetApplicationListPageDto> _getLandlordApplicationListPageByLandlordIdQueryHandler;
        private readonly IQueryHandler<QueryPropertyApplicationDetail, PropertyApplicationRequestDetailDto> _getPropertyApplicationDetailByIdHandler;
        private readonly IQueryHandler<QueryLandlordPropertiesDisplayByLandlordId, GetLandlordPropertiesDisplayDto> _getLandlordPropertiesDisplayByLanlordIdHandler;
        #endregion
        ...
        public UserController(
            ...
            IQueryHandler<QueryTenantPropertyApplication, GetPropertyAppliedDto> getTenantPropertyApplicationHandler,
           /// Landlord handlers
            ...
            IQueryHandler<QueryLandlordApplicationsListPageByLandlordId, GetApplicationListPageDto> getLandlordApplicationListPageByLandlordIdQueryHandler,            
            IQueryHandler<QueryPropertyApplicationDetail, PropertyApplicationRequestDetailDto> getPropertyApplicationDetailByIdHandler,
            IQueryHandler<QueryLandlordPropertiesDisplayByLandlordId, GetLandlordPropertiesDisplayDto> getLandlordPropertiesDisplayByLanlordIdHandler)            
        {
            ...
            _getTenantPropertyApplicationHandler = getTenantPropertyApplicationHandler; 
            ...
            _getLandlordApplicationListPageByLandlordIdQueryHandler = getLandlordApplicationListPageByLandlordIdQueryHandler;
            ...
            _getPropertyApplicationDetailByIdHandler = getPropertyApplicationDetailByIdHandler;
            _getLandlordPropertiesDisplayByLanlordIdHandler = getLandlordPropertiesDisplayByLanlordIdHandler;
        }
        ...
        [HttpGet("GetPropertyAppliedby/{propertyId}/{applicationRequestId}")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<GetPropertyAppliedDto>> GetPropertyApplied(string propertyId, Guid applicationRequestId)
        {
            ...
            return await _getTenantPropertyApplicationHandler.HandleAsync(new QueryTenantPropertyApplication(propertyId, applicationRequestId));
        }
        ...
        [HttpGet("landlord/claimDisplay/{landlordId}/{pageNumber}/{pageSize}/{Descending}")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<GetLandlordClaimsDisplayDto>> GetLandlordClaimedProperties(Guid landlordId, int pageNumber, int pageSize, bool descending)
        {
            if (!ModelState.IsValid)
                return BadRequest();

            return Ok(await _getPropertyClaimsDisplayByLanlordIdHandler.HandleAsync(new QueryPropertyClaimsDisplayByLandlordId(landlordId, pageNumber, pageSize, descending)));
        }

        [HttpGet("landlord/{landlordId}/{propertyId}/{sortBy}/{asc}/{pageNumber}/{pageSize}/dashboard")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<GetApplicationListPageDto>> GetApplicationsDashboard(Guid landlordId, string propertyId,SortApplicationsBy sortBy,bool asc, int pageNumber, int pageSize)
        {
            if (!ModelState.IsValid)  return BadRequest();
            return await _getLandlordApplicationListPageByLandlordIdQueryHandler.HandleAsync(new QueryLandlordApplicationsListPageByLandlordId(landlordId,propertyId,sortBy,asc,pageNumber,pageSize));
        }

        [HttpGet("landlord/application-request/{propertyApplicationId}/detail")]
        [ProducesResponseType(typeof(PropertyApplicationRequestDetailDto), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<PropertyApplicationRequestDetailDto>> GetPropertyApplicationRequestDetail(Guid propertyApplicationId)
        {
            if (!ModelState.IsValid)
                return BadRequest();

            return await _getPropertyApplicationDetailByIdHandler.HandleAsync(new QueryPropertyApplicationDetail(propertyApplicationId));
        }


        [HttpGet("landlord/propertiesDisplay/{landlordId}/{pageNumber}/{pageSize}/{orderBy}/{descending}")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<GetLandlordClaimsDisplayDto>> GetLandlordPropertiesDisplay(Guid landlordId, int pageNumber, int pageSize, LandlordPropertyDisplaySortByEnum orderBy, bool descending)
        {
            if (!ModelState.IsValid)
                return BadRequest();

            return Ok(await _getLandlordPropertiesDisplayByLanlordIdHandler.HandleAsync(new QueryLandlordPropertiesDisplayByLandlordId(landlordId, pageNumber, pageSize, orderBy, descending)));
        }
        #endregion
    }
}