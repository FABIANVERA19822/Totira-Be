...
builder.Services.Configure<SecurityHeadersConfiguration>(builder.Configuration.GetSection("SecurityHeaders"));
// Event Hub
...
builder.Services.AddScoped<IMaskObject, MaskObject>();
