...
namespace Totira.Bussiness.PropertiesService.Domain
{
    ...
    public class Property : DocumentMLS, IAuditable, IEquatable<Property>
    {
        ...
        public double? MinApproxSquareFootage { get; set; }
        public double? MaxApproxSquareFootage { get; set; }
        ...
        public List<decimal> WashroomsTypePcs { get; set; }
        public List<decimal> WashroomsType { get; set; }
        public List<string> WashroomsTypeLevel { get; set; }
        public List<string> OpenHouseTo { get; set; }
        public List<string> OpenHouseFrom { get; set; }
        public List<DateTime?> OpenHouseDate { get; set; }
        public List<string> Open_House_Link { get; set; }
        public List<string> Open_House_Type { get; set; }
        public List<string> AccessToProperty { get; set; }
        public List<string> PortionPropertyLease { get; set; }
        public List<string> Basement { get; set; }
        public List<string> Level { get; set; }
        public List<string> SpecialDesignation { get; set; }
        public List<string> WaterFeatures { get; set; }
        public List<string> Shoreline { get; set; }
        public List<string> AlternativePower { get; set; }
        public List<string> EasementsRestrictions { get; set; }
        public List<string> RuralServices { get; set; }
        public List<string> WaterfrontAccBldgs { get; set; }
        public List<string> WaterDeliveryFeatures { get; set; }
        public List<string> Sewage { get; set; }
