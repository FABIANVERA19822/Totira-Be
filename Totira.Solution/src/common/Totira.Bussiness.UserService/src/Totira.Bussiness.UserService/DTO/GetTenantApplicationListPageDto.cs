...
namespace Totira.Bussiness.UserService.DTO
{
	...
	{
        public List<TenantSingleApplication> ApplicationListPage { get; set; } = new List<TenantSingleApplication>();
    ...
    public class TenantSingleApplication
    {
        ...
        public List<CoApplicantsImageAndName> CoApplicantsInfo { get; set; } = new List<CoApplicantsImageAndName>();
