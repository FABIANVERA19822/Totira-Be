...
public class StudyDetailDto
{
    private StudyDetailDto(
        ...
        List<TenantFileDisplayDto>? enrollmentProof,
    ...
    public List<TenantFileDisplayDto>? EnrollmentProof { get; set; }
    public List<TenantFileDisplayDto>? StudyPermitOrVisa { get; set; }
