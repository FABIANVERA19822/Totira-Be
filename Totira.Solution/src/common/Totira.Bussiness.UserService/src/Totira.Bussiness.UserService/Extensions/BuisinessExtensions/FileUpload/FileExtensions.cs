...
{
    public static bool HaveDuplicates(this List<Domain.Common.File> files, FileInfoDto file, out int coincidences)
    {
    ...
    public static void RenameWhenIsDuplicated(this FileInfoDto fileInfoDto, int count)
    {
