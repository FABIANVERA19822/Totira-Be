...
{
    public class UpdateTenantContactInformationCommandValidator : IMessageValidator<UpdateTenantContactInformationCommand>
    {
        public ValidationResult Validate(UpdateTenantContactInformationCommand command)
        {
