...
{
    public class CreateTenantAcquaintanceReferralCommandValidator : IMessageValidator<CreateTenantAcquaintanceReferralCommand>
    {
        public ValidationResult Validate(CreateTenantAcquaintanceReferralCommand command)
        {
