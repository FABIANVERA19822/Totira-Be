...
{
    public class UpdateTenantEmploymentReferenceCommandValidator : IMessageValidator<UpdateTenantEmploymentReferenceCommand>
    {

        public ValidationResult Validate(UpdateTenantEmploymentReferenceCommand command)
        {
