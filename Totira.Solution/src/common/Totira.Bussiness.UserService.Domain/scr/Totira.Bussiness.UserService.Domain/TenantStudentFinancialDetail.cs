...
public sealed class TenantStudentFinancialDetail : Document
{
    ...
    public List<TenantFile> EnrollmentProofs { get; set; } = new();
    public List<TenantFile> StudyPermitsOrVisas { get; set; } = new();
    public List<TenantFile> IncomeProofs { get; set; } = new();
