...
using Totira.Business.ThirdPartyIntegrationService.Handlers.Commands;
...
using Totira.Business.ThirdPartyIntegrationService.Validators.Certn;
...
namespace Totira.Business.ThirdPartyIntegrationService.Extensions
{
    public static class ServiceCollectionsExtensions
    {
        public static IServiceCollection AddServices(this IServiceCollection services)
        {
            ...
            services.AddQueryHandler<QueryGroupVerifiedProfile, ListTenantGroupVerifiedProfileDto, QueryGroupVerifiedProfileHandler>();
            ...
            services.AddCommandHandler<CreateTenantGroupVerifiedProfileCommand, CreateTenantGroupVerifiedProfileCommandHandler>();
            services.AddCommandHandler<UpdateTenantGroupVerifiedProfileCommand, UpdateTenantGroupVerifiedProfileCommandHandler>();
            ...
            services.AddCommandHandler<ApplyCertnGroupCommand, ApplyCertnGroupCommandHandler, ApplyCertnGroupCommandValidator>();
            services.AddCommandHandler<ApplyJiraGroupCommand, ApplyJiraGroupCommandHandler>();
            services.AddCommandHandler<CreateLandlordPropertyClaimsJiraTicketCommand, CreateLandlordPropertyClaimsJiraTicketCommandHandler, CreateLandlordPropertyClaimsJiraTicketCommandValidator>();
            services.AddCommandHandler<UpdateLandlordPropertyClaimJiraTicketCommand, UpdateLandlordPropertyClaimJiraTicketCommandHandler, UpdateLandlordPropertyClaimJiraTicketCommandValidator>();
