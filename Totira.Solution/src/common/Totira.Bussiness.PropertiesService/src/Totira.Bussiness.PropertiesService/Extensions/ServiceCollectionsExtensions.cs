...
namespace Totira.Bussiness.PropertiesService.Extensions
{
    public static class ServiceCollectionsExtensions
    {
        public static IServiceCollection AddServices(this IServiceCollection services)
        {
            ...
            services.AddQueryHandler<QueryPropertyDetailsToApply, GetPropertyDetailstoApplyDto, GetPropertyDetailsToApplyQueryHandler>();
            services.AddQueryHandler<QueryPropertyCarrouselImagesByMl_num, GetPropertyCarrouselImagesDto, GetPropertyCarrouselImagesByMlnumQueryHandler>();
            services.AddQueryHandler<QueryPropertyMap, IEnumerable<GetPropertyMapDto>, GetPropertyMapQueryHandler>();
            services.AddQueryHandler<QueryPropertyApplicationDetail, GetPropertyApplicationDetailDto, GetPropertyApplicationDetailQueryHandler>();
