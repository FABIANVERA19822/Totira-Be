namespace Totira.Bussiness.PropertiesService.DTO
{
    public class GetPropertyDetailsDto
    {
        ...
        public GetPropertyDetailsDto(string id, DateTime? listingentrydate, string status, string area, string address, string frontingOnNSEW, string approxSquareFootage,
        ...
        {
            Id = id;
            ListingEntryDate = listingentrydate; 
            Status = status;
            Area = area;
            Address = address;
